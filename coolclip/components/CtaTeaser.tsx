...
import { Wind, ShieldCheck, Truck, Clock, Sparkles, Flame } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="bg-[#1A1A1A] text-[#F4F3ED] rounded-3xl p-8 sm:p-12 border-4 border-white shadow-2xl space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-6">
            <div className="inline-flex items-center gap-2 bg-[#6E8F7E] text-white px-3.5 py-1.5 rounded-full text-xs font-mono-accent tracking-wider font-bold">
              <Sparkles className="w-3.5 h-3.5" />
              <span>EARLY BIRD BATCH #1 PRE-ORDER</span>
            </div>

            <div className="flex items-center gap-2 text-xs font-mono-accent text-[#C8C1AE] bg-[#2A2A2A] px-3 py-1 rounded border border-white/10">
              <Flame className="w-4 h-4 text-[#6E8F7E] animate-pulse" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <p className="text-base sm:text-lg text-[#F4F3ED]/80 leading-relaxed">
                Wees er als eerste bij en claim jouw CoolClip tegen de scherpste introductievoorwaarden. Inclusief USB-C snellaadkabel, reisetui en 2 jaar avontuur-garantie.
              </p>
            </div>

            {/* Price Box */}
            <div className="lg:col-span-5 bg-[#2A2A2A] rounded-2xl p-6 border border-white/10 text-center space-y-3">
              <span className="text-xs font-mono-accent text-[#C8C1AE] uppercase tracking-wider block">
                INTRODUCTIEPRIJS (LIMITED BATCH)
              </span>
              ...
              <span className="inline-block bg-[#6E8F7E]/20 text-[#6E8F7E] text-xs font-mono-accent font-bold px-3 py-1 rounded border border-[#6E8F7E]/30">
          ...
          <div className="pt-4 border-t border-white/10 space-y-4">
            {submitted ? (
              <div className="bg-[#6E8F7E]/20 border border-[#6E8F7E] text-[#F4F3ED] p-6 rounded-xl text-center space-y-2 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 text-xs font-mono-accent text-[#F4F3ED]/70">
              ...
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4 text-[#6E8F7E] shrink-0" />
